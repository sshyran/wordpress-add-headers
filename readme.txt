...
WordPress. Add-Headers adds the *Expires* and *Cache-Control* headers to the feeds.
...
By setting a *max-age* setting to `0`, a `Cache-Control: no-cache, must-revalidate, max-age=0`
header is sent.
